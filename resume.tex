...
\begin{minipage}[t]{0.59\textwidth}%
  ...
  \begin{heading}{Experience}%
    ...
    \begin{experience}{Software Engineer 3}
      ...
      \begin{itemize*}
      % 1. phrase this in a way that showcases skill
      % 2. what tracks of work?
      % 3. too broad, narrow it down
      \item Was mentored by a more senior engineer and involved in conversations
        that steered the technical direction of a new team.
      \item Performed a
    ...
    \begin{experience}{Software Engineer 2}
      ...
      \begin{itemize*}
        \item Led and designed a track of work where a software system,
...
\begin{minipage}[t]{0.39\textwidth}%
  ...
  \begin{heading}{Projects}
    ...
    \begin{project}{Tanzu Developer Portal}
      ...
      \begin{itemize*}
        \item Full stack web app in Node, Typescript and React that enabled
          users to create internal developer portals.
        \item Several teams, approximately 30 engineers total, maintained
          plugins that were reviewed and integrated by us
        \item Was the first Backstage offering to market with \linebreak no-code
          configurable plugins.
        \item Featured a \href{https://carvel.dev}{carvel} install that
          automated away many pain points of the Backstage install process
      \end{itemize*}
    \end{project}
