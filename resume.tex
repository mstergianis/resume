...
\begin{itemize}
  ...
  \item Strong in the following programming languages: Python,
  Clojure, C++, Java
...
\begin{itemize}
  ...
  \item Strong background in linear algebra and calculus
  \item Proficiency in many programming languages
  \item Strong understanding of principles of computer science
\end{itemize}
\end{*subsection}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% Coursera
