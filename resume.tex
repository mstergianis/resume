\documentclass[]{article} \usepackage{lmodern} \usepackage{tabu}
\usepackage{floatrow} \usepackage{tgpagella}
\usepackage{amssymb,amsmath} \usepackage{ifxetex,ifluatex}
\usepackage{fancyhdr} \usepackage[margin=1.15in]{geometry}
...
\item
  Familiar with a variety of programming languages such as: Python,
  C/C++, Java, Go, Clojure
\item
...
%%% Scholarship
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\OneLiner{In-Course Scholarship (UOIT)}{2014 -- 2017}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% CIBC
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\OneLiner{Completion of the CIBC Run for the Cure}{2016 -- 2017} \par
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% %%%% References
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% \heading{References:}
